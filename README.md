...
Major platform changes and newly released capabilities:

- **[New Postman Platform (March 2026)](https://blog.postman.com/new-postman-is-here/)** — Full relaunch built for the agentic era. Introduces the API Catalog (a live management plane for all APIs and services), Git-connected Workspaces, and a redesigned Private API Network.
- **[Agent Mode](https://learning.postman.com/docs/getting-started/basics/about-postbot)** — Replaces Postbot in Postman v12. Natural-language AI interface for writing tests, generating documentation, fixing errors, building Flows, and interacting with APIs.
- **[MCP Support](https://blog.postman.com/postman-launches-full-support-for-model-context-protocol-mcp-build-better-ai-agents-faster/)** — Full Model Context Protocol support. Create and send MCP requests directly in Postman, generate MCP servers from 100,000+ APIs, and use deployed Flows as MCP tools for AI agents.
- **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** — Official MCP server to connect AI assistants (Claude, Cursor, etc.) directly to your Postman workspace.
- **[Flow Actions](https://blog.postman.com/new-capabilities-march-2026/)** — Deploy Flows to the cloud and trigger them via API endpoints; use deployed Flows as tools in AI agent pipelines.
- **[Spec Hub](https://blog.postman.com/november-2025-product-updates/)** — Centralized spec management with Spectral linting, OpenAPI 3.0 and AsyncAPI 2.0 support, multi-file references, and bidirectional sync between specs and collections.
- **[CLI Generator](https://blog.postman.com/introducing-the-cli-generator/)** — Generate fully functional CLI applications directly from Postman collections or OpenAPI specs.
- **[Microsoft Collaboration (April 2026)](https://www.businesswire.com/news/home/20260416207345/en/Postman-Announces-Collaboration-with-Microsoft-to-Expand-AI-Model-Choice-Accelerate-Developer-Workflows-and-Unify-API-Governance)** — Agent Mode now supports OpenAI models on Microsoft Foundry; Azure API Management integration is generally available; new Postman app for Microsoft Teams.
- **[Fern Acquisition (January 2026)](https://blog.postman.com/postman-acquires-fern/)** — Postman acquired Fern to strengthen API documentation and SDK generation capabilities.
- **[API Governance](https://learning.postman.com/docs/api-governance/api-governance-overview)** — Enforce style, security, and design rules across your entire API portfolio.
- **[Postman Flows](https://www.postman.com/product/flows)** — Visual, no-code tool to chain API calls and build automated workflows.
...
- [Postman Academy](https://academy.postman.com) — Official interactive courses, live workshops, and certifications, including the Postman API Fundamentals Student Expert program.
...
- [Postman Community Forum](https://community.postman.com) — Official forums for questions, answers, and feature requests.
...
Please see [CONTRIBUTING.md](.github/CONTRIBUTING.md) for guidelines on how to add resources to this list.

## License

[![CC0](https://licensebuttons.net/p/zero/1.0/88x31.png)](https://creativecommons.org/publicdomain/zero/1.0/)

To the extent possible under law, [Dawit Nida](https://github.com/dawitnida) has waived all copyright and related or neighboring rights to this work.
